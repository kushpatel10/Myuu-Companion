const { createShinyLeaderboardEmbed, createGithubUrlButton, createNoPermissionEmbed } = require('../../../core/embeds/mainEmbeds');
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const inputImagePath = path.join(__dirname, '../assets/image.png');
            const outputImagePath = path.join(__dirname, '../assets/output.png');
